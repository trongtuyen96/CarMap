...
interface AuthenticationService {
    ...
    @FormUrlEncoded
    @POST("register/email")
    fun registerWithEmail(@Field("email") email: String, @Field("password") password: String, @Field("name") name: String, @Field("birthDate") birthDate: String, @Field("status") status: String): Call<User>
}